x=function(actor, progress) {
  ...
  */
  ...
  if(progress<=__timing1) {
    angleX=progress*(__skewX/__timing1);
    angleY=progress*(__skewY/__timing1);
  } else if(progress>=__timing2) {
    angleX=__skewX-(progress-__timing2)*(__skewX/(1-__timing2));
    angleY=__skewY-(progress-__timing2)*(__skewY/(1-__timing2));
  } else {
    angleX=__skewX;
    angleY=__skewY;
  }
