...
angular.module('colorpicker.module', [])
    ...
    .directive('colorpicker', ['$document', '$compile', 'Color', 'Slider', 'Helper', '$animate', function ($document, $compile, Color, Slider, Helper, $animate) {
      return {
        require: '?ngModel',
        restrict: 'A',
        link: function ($scope, elem, attrs, ngModel) {
          ...
          elem.on('click', function () {
            ...
            $animate.addClass(colorpickerTemplate, 'colorpicker-visible');

            // register global mousedown event to hide the colorpicker
            $document.on('mousedown mousewheel', documentMousedownHandler);
          });
          ...
          var hideColorpickerTemplate = function() {
            if (colorpickerTemplate.hasClass('colorpicker-visible')) {
              $animate.removeClass(colorpickerTemplate, 'colorpicker-visible');
              emitEvent('colorpicker-closed');
              // unregister the global mousedown event
              $document.off('mousedown mousewheel', documentMousedownHandler);
            }
          };
